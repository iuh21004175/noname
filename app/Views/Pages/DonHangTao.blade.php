        ...
        <div class="row">
            ...
            <div class="col-8" id="form-donHang">
                <form>
                    ...
                    <div>
                        <h5>Danh sách đồ ăn và đồ uống</h5>
                    ...
                    <div>
                        <h5 >Tổng tiền: <input type="number" class="tongTienDH border-0" value="0" disabled></h5>
                        <h5 class="d-inline-block">Tính tiền thối: <input type="text" id="txt-soTienKhachHang" placeholder="Nhập số tiền"> Tiền thối <input type="text" id="txt-tienThoi" disabled></h5>
                    </div>
